...
<section id="legal" class="container">
    ...
    <p>Les informations recueillies sur ce formulaire sont enregistrées dans un fichier informatisé par Sarah Roperch dans le cadre de mon projet de formation présenté à l'examen final.</p>
